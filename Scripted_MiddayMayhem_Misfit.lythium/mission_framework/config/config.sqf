...
EGVAR(intro_text,title) = "Midday Mayhem";  // Title
EGVAR(intro_text,date) = "1400";  // Date
EGVAR(intro_text,location) = "Lythium";  // Location
...
EGVAR(respawn_wave,availableWaves) = 100;  // Number of the available respawn waves
