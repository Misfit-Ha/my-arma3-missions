...
class MissionSuccess {
    ...
    subtitle = "Soviets are Anihilated";          // Closing shot - Short description
    description = "you've successfully completed every task";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Soviets retreating";
    description = "you've successfully completed most tasks";
    pictureBackground = "";
    picture = "mil_flag";
