...
briefingName = "[CO-25] Operation Unthinkable";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = " Operation Unthinkable";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
