...
GVARMAIN(serverViewDistance) = 1600;  // Server view distance (= AI view distance)
...
EGVAR(custom_channel,channelName) = "FAC channel";  // Name of the channel
...
EGVAR(intro_text,title) = "The Monte Dispute";  // Title
EGVAR(intro_text,date) = "1750 January 26, 2035";  // Date
EGVAR(intro_text,location) = "Malden Airfield";  // Location
