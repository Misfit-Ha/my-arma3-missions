...
class MissionSuccess {
    ...
    subtitle = "Hostages rescued";          // Closing shot - Short description
    description = "You managed to capture the objectives and rescue the friendly POW's. Good job.";    // Debriefing - Summary of the mission
...
class MissionFail {
    ...
    subtitle = "The hostages are KIA";
    description = "The hostages were killed in action. Mission failed, we'll get 'em next time.'";
    pictureBackground = "";
    picture = "KIA";
...
class TimeLimitMinorSuccess {
    ...
    description = "You managed to complete most of the objectives. Good effort.";
    pictureBackground = "";
    picture = "mil_flag";
    pictureColor[] = {0, 0.8, 0, 1};
};
...
class TimeLimitMinorFail {
    title = "Minor Defeat";
    subtitle = "Time limit reached";
    description = "You almost did a good job.";
    pictureBackground = "";
    picture = "mil_flag";
    pictureColor[] = {0.9, 0, 0, 1};
};
