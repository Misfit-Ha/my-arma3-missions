...
EGVAR(intro_text,title) = "OPERATION ROYAL FLUSH";  // Title
EGVAR(intro_text,date) = "LATE 1980";  // Date
EGVAR(intro_text,location) = "LINGOR PROVINCE, SAHRANI";  // Location
...
EGVAR(reinsertion,TPPoles) = ["MF_tpPole_1", "MF_tpPole_2"];  // Teleport pole object(s)
...
EGVAR(supply_drop,supplyDropPlane) = "RHS_C130J";  // Plane or helicopter used for the supply drop
