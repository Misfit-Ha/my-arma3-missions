...
EGVAR(intro_text,title) = "The Obligatory D day Mission";  // Title
EGVAR(intro_text,date) = "6 June 1944";  // Date
EGVAR(intro_text,location) = "Off The Coast Of Normandy, France";  // Location
EGVAR(intro_text,delay) = 30;  // Delay after loading in
...
EGVAR(supply_drop,supplyDropPlane) = "LIB_C47_half";  // Plane or helicopter used for the supply drop
