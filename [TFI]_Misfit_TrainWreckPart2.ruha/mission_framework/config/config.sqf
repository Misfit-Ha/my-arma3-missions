...
EGVAR(gear,loadoutHash) = [  // Key-value pairs (STRING - ARRAY OF STRINGS) for the alternative loadouts (Coop & TvT)
    ["LEADERSHIP - L85", ["LEADERSHIP - L119"]],
    ["MEDIC - L119", ["MEDIC - L91a1"]],
    ["AUTORIFLEMAN - L7a2", ["AUTORIFLEMAN - Minimi"]],
    ["RIFLEMAN - L85", ["RIFLEMAN - L119"]]
];
...
EGVAR(intro_text,title) = "Train Wreck";  // Title
EGVAR(intro_text,date) = "2020-06-26 19:45";  // Date
EGVAR(intro_text,location) = "NEAR Metsala, RUHA";  // Location
