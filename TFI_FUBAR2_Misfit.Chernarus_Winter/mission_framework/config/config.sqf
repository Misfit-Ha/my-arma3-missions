...
EGVAR(end_conditions,civilianCasLimit) = 90;  // Percentage of the max. allowed civilian casualty
...
EGVAR(gear,enableAlternativeLoadouts) = true;  // Enable alternative loadouts
EGVAR(gear,loadoutHash) = [  // Key-value pairs (STRING - ARRAY OF STRINGS) for the alternative loadouts (defined in config\gear\)
    ["LEADERSHIP - G38GL", ["LEADERSHIP - G36GL", "LEADERSHIP - hk416GL", "LEADERSHIP - G27GL"]],
    ["MEDIC - G38", ["MEDIC - G36", "G36", "MEDIC - hk416"]],
    ["AUTORIFLEMAN - MG3", ["AUTORIFLEMAN - MG4", "AUTORIFLEMAN - MG5"]],
    ["RIFLEMAN - G38", ["RIFLEMAN - G36", "RIFLEMAN - hk416"]],
    ["RIFLEMAN - G38 carl gustav", ["RIFLEMAN - G36 carl gustav", "RIFLEMAN - HK416 carl gustav Hossein-Niazi Special"]],
    ["SNIPER - G29", ["SNIPER - G22"]]
];


// Respawn
GVARMAIN(moduleRespawn) = true;  // Coop & TvT
EGVAR(respawn,timer) = 300;  // Respawn timer in seconds
...
// View distances
GVARMAIN(playerViewDistance) = 1600;  // Player view distance
...
EGVAR(cbrn,protectiveMasks) = ["G_AirPurifyingRespirator_01_F" ];  // Masks that provide protection (LVL 1)
...
EGVAR(intro_text,title) = "FUBAR Part 2";  // Title
EGVAR(intro_text,date) = "0730 January 27, 2020";  // Date
