...
briefingName = "[CO-20] Blackfish And Chips";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = "Blackfish And Chips";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
