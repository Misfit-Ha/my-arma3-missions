...
switch (_dir) do {
    case "north" : {
        _startPos = [(_playerPos#0), (_playerPos#1) + 5000, 500];
        _endPos = [(_playerPos#0), (_playerPos#1) - 150, 500];
    };
    case "east" : {
        _startPos = [(_playerPos#0) + 5000, (_playerPos#1), 500];
        _endPos = [(_playerPos#0) - 150, (_playerPos#1), 500];
    };
    case "south" : {
        _startPos = [(_playerPos#0), (_playerPos#1) - 5000, 500];
        _endPos = [(_playerPos#0), (_playerPos#1) + 150, 500];
