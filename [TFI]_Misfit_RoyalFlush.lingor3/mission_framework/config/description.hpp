...
briefingName = "[CO-30] Royal Flush";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = "Royal Flush";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
onLoadMission = "Lingor, Sahrani";  // Mission description on the loading screen
