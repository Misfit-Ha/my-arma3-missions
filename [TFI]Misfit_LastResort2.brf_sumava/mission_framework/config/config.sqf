...
// View distances
GVARMAIN(playerViewDistance) = 700;  // Player view distance
GVARMAIN(serverViewDistance) = 700;  // Server view distance (= AI view distance)
...
EGVAR(intro_text,date) = "Post WW2";  // Date
EGVAR(intro_text,location) = "Susice, Sumava";  // Location
...
EGVAR(supply_drop,supplyDropPlane) = "sab_sw_il2_2";  // Plane or helicopter used for the supply drop
