...
class MissionSuccess {
    ...
    subtitle = "You ve successfully retooke the city";          // Closing shot - Short description
    description = "good job, you vee completely captured the city  ";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "you ve captured most of the city";
    description = "good job, you ve partially captured the city";
    pictureBackground = "";
    picture = "mil_flag";
