...
class MissionSuccess {
    ...
    subtitle = "The sabotage was successful";          // Closing shot - Short description
    description = "You managed to destroy the SAM sites, disable their radio comms and radar station. Finally, the submarine was sank. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "The sabotage was mostly successful";
    description = "You completed most of the objectives causing serious damage to their defence systems. However, not every task was completed. Good job nonetheless.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    ...
    description = "You caused some disruption but couldn't complete the objective. Good effort, lads.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    description = "Total defeat. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
...
class TimeLimitMinorSuccess {
    ...
    description = "You completed most of the objectives causing serious damage to their defence systems. However, you ran out of time. Good job nonetheless.";
    pictureBackground = "";
    picture = "mil_flag";
    pictureColor[] = {0, 0.8, 0, 1};
};
...
class TimeLimitMinorFail {
    title = "Minor Defeat";
    subtitle = "Time limit reached";
    description = "You caused some disruption but couldn't complete the objective in time. Good effort, lads.";
    pictureBackground = "";
    picture = "mil_flag";
    pictureColor[] = {0.9, 0, 0, 1};
};
