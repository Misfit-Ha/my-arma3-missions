...
briefingName = "[CO-20] The Monte Dispute pt2";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = "[CO-20] The Monte Dispute pt2";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
onLoadMission = "Get out there, have a good time :)";  // Mission description on the loading screen
