...
private _classBlacklist = ["Land_DataTerminal_01_F","Wreck_Base","FlagCarrierCore","Base_CUP_Plant","Crater","Land_CamoNetVar_EAST","Land_HelipadCivil_F","Land_Cargo20_military_green_F","Land_CzechHedgehog_01_old_F","Land_SandbagBarricade_01_hole_F"]; //blacklist of item or parent classes to never mark
