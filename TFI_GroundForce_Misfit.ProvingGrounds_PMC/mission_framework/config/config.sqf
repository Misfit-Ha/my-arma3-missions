...
EGVAR(gear,loadoutHash) = [  // Key-value pairs (STRING - ARRAY OF STRINGS) for the alternative loadouts (defined in config\gear\)
    ["LO1", ["LO - P90", "LO - VSS", "LO - MP5GL", "LO - Shotgun", "LO - Mosin", "LO - grease gun", "LO - Crossbow", "LO - M1", "LO - MP5 Apex"]]
];
...
EGVAR(intro_text,title) = "Ground Force";  // Title
EGVAR(intro_text,date) = "2045-06-26 18:20";  // Date
EGVAR(intro_text,location) = "Proving Ground";  // Location
