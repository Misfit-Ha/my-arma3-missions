...
class MissionSuccess {
    ...
    subtitle = "all hostages have been rescued";          // Closing shot - Short description
    description = "Irish Special forces have successfully rescued everyone";    // Debriefing - Summary of the mission
