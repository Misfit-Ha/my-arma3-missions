...
overviewText = "British SF secure a chemical factory. // Assets: 1x APC (callsign: HAMMER) // Respawns: unlimited, Wave // Arsenal mode: Alt Loadouts // Time limit: disabled // Staging: disabled // JIP: enabled"; // Mission info on the mission selection screen (e.g. mission assets, factions, time limit etc.)

// Loading screen settings
onLoadName = "Train Wreck 2";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
