...
force grad_captiveWalking_functions_allowRunning = true;
force grad_captiveWalking_functions_allowWalkingWhileCaptiv = true;
force grad_captiveWalking_functions_disableEscorting = true;
force grad_captiveWalking_functions_freeingTime = 30;
...
// TFI Animation
force TFI_Anim_CBA_disHitReaction = true;
