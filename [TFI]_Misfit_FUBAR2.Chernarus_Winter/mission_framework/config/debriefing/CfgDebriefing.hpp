...
class MissionSuccess {
    ...
    subtitle = "The Chadaki forces are falling back";          // Closing shot - Short description
    description = "You managed to complete the objectives and push back the Chedaki forces. Good job.";    // Debriefing - Summary of the mission
