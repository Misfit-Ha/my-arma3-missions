...
class MissionSuccess {
    ...
    subtitle = "You escaped from Sumaava";              // Closing shot - Short description
    description = "You successfully managed to escape from Sumava.";    // Debriefing - Summary of the mission
