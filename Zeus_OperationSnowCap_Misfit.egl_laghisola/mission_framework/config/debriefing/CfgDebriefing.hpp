...
class MissionSuccess {
    ...
    subtitle = "success";          // Closing shot - Short description
    description = "You've successfully eliminated all drug operations in this area";    // Debriefing - Summary of the mission
