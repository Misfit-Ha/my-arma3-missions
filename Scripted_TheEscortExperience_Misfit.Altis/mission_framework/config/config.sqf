...
EGVAR(intro_text,title) = "The Escort Experience";  // Title
EGVAR(intro_text,date) = "2036-11-30 midnight";  // Date
EGVAR(intro_text,location) = "Feres, 1km NW of harbor";  // Location
