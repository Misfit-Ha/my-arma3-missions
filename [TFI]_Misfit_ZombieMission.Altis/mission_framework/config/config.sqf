...
EGVAR(gear,loadoutHash) = [  // Key-value pairs (STRING - ARRAY OF STRINGS) for the alternative loadouts (Coop & TvT)
    ["LEADERSHIP - G38GL", ["LEADERSHIP - G36GL"]],
    ["MEDIC - G38", ["MEDIC - G36"]],
    ["AUTORIFLEMAN - MG3", ["AUTORIFLEMAN - MG4"] , ["AUTORIFLEMAN - MG5"]],
    ["RIFLEMAN - G38", ["RIFLEMAN - G36"]],
    ["RIFLEMAN - G38 carl gustav", ["RIFLEMAN - G36 carl gustav"]]
];
...
// View distances
GVARMAIN(playerViewDistance) = 400;  // Player view distance
...
EGVAR(intro_text,title) = "A zombie mission";  // Title
EGVAR(intro_text,date) = "0300 January 26, 2045";  // Date
EGVAR(intro_text,location) = "Somewhere in altis";  // Location
...
EGVAR(supply_drop,supplyDropPlane) = "UK3CB_BAF_Merlin_HC3_18_DPMW_RM";  // Plane or helicopter used for the supply drop
