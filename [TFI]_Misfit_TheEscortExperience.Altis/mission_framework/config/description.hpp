...
briefingName = "[CO-20] The Escort Experience";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = "Misfit_The_Escort_Experience";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
onLoadMission = "Move, figet, die, repeat";  // Mission description on the loading screen
