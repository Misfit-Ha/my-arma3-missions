...
class MissionSuccess {
    ...
    subtitle = "The diplomat has been secured";          // Closing shot - Short description
    description = "You managed to capture the ammo depot and rescue the diplomat. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Ammo depot secured";
    description = "You managed to secure the ammo depot. Good job, I guess?";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "The VIP is KIA";
    description = "The diplomat was killed in action. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
