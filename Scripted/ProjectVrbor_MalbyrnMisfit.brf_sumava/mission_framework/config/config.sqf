...
GVARMAIN(serverViewDistance) = 400;  // Server view distance (= AI view distance)
...
EGVAR(intro_text,date) = "21:00 31rd October, 2023";  // Date
EGVAR(intro_text,location) = "Maly Bor, Sumava";  // Location
