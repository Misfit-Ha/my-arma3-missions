...
nul = [this] execVM "ALambientbattle\alias_flaks.sqf";
...
nul = [this] execVM "ALambientbattle\alias_artillery.sqf";
...
nul = [this,"red"] execVM "ALambientbattle\alias_tracers.sqf";
nul = [this,"green"] execVM "ALambientbattle\alias_tracers.sqf";
nul = [this,"white"] execVM "ALambientbattle\alias_tracers.sqf";
...
nul = [tracers_object_name_1,"red"] execVM "ALambientbattle\alias_tracers.sqf";

============== Missile launch ==============
EX1 - place the line below in the init field of the object you wanr as missile generator
nul = [this] execVM "ALambientbattle\alias_missiles.sqf";
...
============== Search light ==============
null = [object,enable_sound] execVM "ALambientbattle\aaa_search_light.sqf"
...
null = [this,true] execVM "ALambientbattle\aaa_search_light.sqf"

Ex2 - use line below to run the script from global space like for example init.sqf
null = [my_search_light,false] execVM "ALambientbattle\aaa_search_light.sqf"
