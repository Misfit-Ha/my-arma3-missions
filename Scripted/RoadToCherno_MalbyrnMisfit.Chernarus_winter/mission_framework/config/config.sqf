...
// View distances
GVARMAIN(playerViewDistance) = 1100;  // Player view distance
GVARMAIN(serverViewDistance) = 1100;  // Server view distance (= AI view distance)
...
EGVAR(intro_text,date) = "2036-11-30 08:00";  // Date
