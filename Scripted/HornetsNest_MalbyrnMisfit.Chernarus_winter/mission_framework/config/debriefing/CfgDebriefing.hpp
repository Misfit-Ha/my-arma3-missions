...
class MissionSuccess {
    ...
    subtitle = "Successfully captured all objective";          // Closing shot - Short description
    description = "You managed to capture every strategic location. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Captured most of the objectives";
    description = "You managed to capture most of the strategic locations. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "Captured some of the objectives";
    description = "You managed to capture some of the strategic locations. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "No objective was captured";
    description = "You didn't manage to capture any objective. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
