...
EGVAR(intro_text,title) = "Operation Unthinkable";  // Title
EGVAR(intro_text,date) = "0414 April 26, 1945";  // Date
EGVAR(intro_text,location) = "Sumava";  // Location
...
EGVAR(supply_drop,supplyDropPlane) = "LIB_C47_Skytrain";  // Plane or helicopter used for the supply drop
