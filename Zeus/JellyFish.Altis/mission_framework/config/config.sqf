...
// View distances
GVARMAIN(playerViewDistance) = 2000;  // Player view distance
...
EGVAR(ai_skills,skillSet) = [
    ...
    0.8,  // Aiming Accuracy (Higher = Better)
    0.8,  // Aiming Shake (Higher = Less)
    0.8,  // Aiming Speed (Higher = Faster)
...
EGVAR(intro_text,title) = "Operation Neptun";  // Title
EGVAR(intro_text,date) = "Summer 2035";  // Date
EGVAR(intro_text,location) = "USS Liberty, Gulf of Pygros";  // Location
