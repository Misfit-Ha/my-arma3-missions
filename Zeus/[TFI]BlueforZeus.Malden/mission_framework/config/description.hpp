...
briefingName = "[CO-60] Blufor Zeus";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = "[CO-60] Blufor Zeus";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
