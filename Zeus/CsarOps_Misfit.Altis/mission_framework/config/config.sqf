...
// View distances
GVARMAIN(playerViewDistance) = 1700;  // Player view distance
GVARMAIN(serverViewDistance) = 1700;  // Server view distance (= AI view distance)
...
EGVAR(intro_text,title) = "CSAR OPS";  // Title
EGVAR(intro_text,date) = "EARLY MORNINT";  // Date
EGVAR(intro_text,location) = "ALTIS";  // Location
