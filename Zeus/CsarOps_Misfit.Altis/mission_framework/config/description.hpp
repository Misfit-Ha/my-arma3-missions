...
briefingName = "[CO-15] CSAR OP ALTIS";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = "[CO-15] CSAR OP ALTIS";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
