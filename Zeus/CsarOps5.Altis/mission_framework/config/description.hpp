...
briefingName = "[CO-15] Olympus Dawn";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = "[CO-15] Olympus Dawn";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
