...
EGVAR(respawn,timer) = 100;  // Respawn timer in seconds
...
EGVAR(cbrn,protectiveMasks) = ["MASK_M50"];  // Masks that provide protection (LVL 1)
...
EGVAR(cbrn,protectiveVehicles) = ["B_GEN_APC_Wheeled_02_hmg_lxWS"];  // Vehicles that provide protection (LVL 3)
...
EGVAR(intro_text,title) = "DAMAGE CONTROL";  // Title
EGVAR(intro_text,date) = "PRESENT TIME";  // Date
EGVAR(intro_text,location) = "YULAKIA";  // Location
