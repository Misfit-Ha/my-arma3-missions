...
briefingName = "[CO-15] Paint The Town Blue";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
...
onLoadName = "[CO-15] Paint The Town Blue";  // Name of the operation on the loading screen (you can drop the [CO-XX] part here)
