...
class MissionSuccess {
    ...
    subtitle = "You stopped the local insurgents";          // Closing shot - Short description
    description = "You successfully stopped the local insurgency. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "You stopped most of the local insurgents";
    description = "You successfully stopped most of the local insurgency. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "You failed to stop the rest of the insurgents";
    description = "You failed to stop the rest of the insurgents. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "Insurgency is still present";
    description = "You failed to stop the insurgents. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
